const countriesData = {
    "Afrique": {
        ...
        "regions": [
            ...
            { name: "Afrique de l'Ouest", countries: [
                ...
                { country: "Côte d'Ivoire", capital: "Yamoussoukro", flag: "https://upload.wikimedia.org/wikipedia/commons/f/fe/Flag_of_C%C3%B4te_d%27Ivoire.svg" },
            ...
            { name: "Afrique Centrale", countries: [
                ...
                { country: "Sao Tomé-et-Principe", capital: "São Tomé", flag: "https://upload.wikimedia.org/wikipedia/commons/4/4f/Flag_of_Sao_Tome_and_Principe.svg" }
            ]},
            { name: "Afrique de l'Est", countries: [
                { country: "Burundi", capital: "Gitega", flag: "https://upload.wikimedia.org/wikipedia/commons/5/50/Flag_of_Burundi.svg" },
                { country: "Comores", capital: "Moroni", flag: "https://upload.wikimedia.org/wikipedia/commons/9/90/Flag_of_the_Comoros.svg" },
                { country: "Djibouti", capital: "Djibouti (ville)", flag: "https://upload.wikimedia.org/wikipedia/commons/3/34/Flag_of_Djibouti.svg" },
                { country: "Érythrée", capital: "Asmara", flag: "https://upload.wikimedia.org/wikipedia/commons/9/92/Flag_of_Eritrea.svg" },
                ...
                { country: "Malawi", capital: "Lilongwe", flag: "https://upload.wikimedia.org/wikipedia/commons/3/30/Flag_of_Malawi.svg" },
                ...
                { country: "Seychelles", capital: "Victoria", flag: "https://upload.wikimedia.org/wikipedia/commons/9/9f/Flag_of_Seychelles.svg" },
                { country: "Somalie", capital: "Mogadiscio", flag: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Flag_of_Somalia.svg/800px-Flag_of_Somalia.svg.png" },
            ...
            { name: "Afrique Australe", countries: [
                ...
                { country: "Zimbabwe", capital: "Harare", flag: "https://upload.wikimedia.org/wikipedia/commons/d/da/Flag_of_Zimbabwe.svg" }
            ]}
        ]
    },
    "Amérique": {
        "colorClass": "red",
        "regions": [
            { name: "Amérique du Nord", countries: [
                { country: "Antigua-et-Barbuda", capital: "Saint John's", flag: "https://upload.wikimedia.org/wikipedia/commons/8/87/Flag_of_Antigua_and_Barbuda.svg" },
                ...
                { country: "Costa Rica", capital: "San José", flag: "https://upload.wikimedia.org/wikipedia/commons/b/bc/Flag_of_Costa_Rica.svg" },
                { country: "Cuba", capital: "La Havane", flag: "https://upload.wikimedia.org/wikipedia/commons/b/bd/Flag_of_Cuba.svg" },
                { country: "Dominique", capital: "Roseau", flag: "https://upload.wikimedia.org/wikipedia/commons/0/04/Flag_of_Dominica.svg" },
                ...
                { country: "Honduras", capital: "Tegucigalpa", flag: "https://upload.wikimedia.org/wikipedia/commons/8/82/Flag_of_Honduras.svg" },
                ...
                { country: "Sainte-Lucie", capital: "Castries", flag: "https://upload.wikimedia.org/wikipedia/commons/9/9c/Flag_of_Saint_Lucia.svg" },
            ...
            { name: "Amérique du Sud", countries: [
                { country: "Argentine", capital: "Buenos Aires", flag: "https://upload.wikimedia.org/wikipedia/commons/1/1a/Flag_of_Argentina.svg" },
                { country: "Bolivie", capital: "Sucre (constitutionnelle), La Paz (administrative)", flag: "https://upload.wikimedia.org/wikipedia/commons/b/b3/Flag_of_Bolivia.svg" },
    ...
    "Asie": {
        ...
        "regions": [
            ...
            { name: "Asie du Sud", countries: [
                { country: "Afghanistan", capital: "Kaboul", flag: "https://upload.wikimedia.org/wikipedia/commons/9/9a/Flag_of_Afghanistan.svg" },
            ...
            { name: "Asie du Sud-Est", countries: [
                ...
                { country: "Singapour", capital: "Singapour", flag: "https://upload.wikimedia.org/wikipedia/commons/4/41/Flag_of_Singapore.svg" },
            ...
            { name: "Asie de l'Ouest (Moyen-Orient)", countries: [
                ...
                { country: "Jordanie", capital: "Amman", flag: "https://upload.wikimedia.org/wikipedia/commons/0/0a/Flag_of_Jordan.svg" },
                ...
                { country: "Syrie", capital: "Damas", flag: "https://upload.wikimedia.org/wikipedia/commons/5/53/Flag_of_Syria.svg" },
    ...
    "Europe": {
        "colorClass": "blue",
        "regions": [
            { name: "Europe de l'Ouest", countries: [
                ...
                { country: "Royaume-Uni", capital: "Londres", flag: "https://upload.wikimedia.org/wikipedia/commons/a/ae/Flag_of_the_United_Kingdom.svg" },
                { country: "Suisse", capital: "Berne", flag: "https://upload.wikimedia.org/wikipedia/commons/f/f3/Flag_of_Switzerland.svg" }
            ]},
            { name: "Europe de l'Est", countries: [
                { country: "Albanie", capital: "Tirana", flag: "https://upload.wikimedia.org/wikipedia/commons/7/78/Flag_of_Albania.svg" },
                ...
                { country: "Hongrie", capital: "Budapest", flag: "https://upload.wikimedia.org/wikipedia/commons/8/8e/Flag_of_Hungary.svg" },
            ...
            { name: "Europe du Sud", countries: [
                ...
                { country: "Vatican", capital: "Cité du Vatican", flag: "https://upload.wikimedia.org/wikipedia/commons/0/00/Flag_of_the_Vatican_City.svg" }
            ]}
        ]
    },
    "Océanie": {
        ...
        "regions": [
            { name: "Océanie", countries: [
                ...
                { country: "Fidji", capital: "Suva", flag: "https://upload.wikimedia.org/wikipedia/commons/9/91/Flag_of_Fiji.svg" },
                ...
                { country: "Micronésie", capital: "Palikir", flag: "https://upload.wikimedia.org/wikipedia/commons/e/ef/Flag_of_the_Federated_States_of_Micronesia.svg" },
                ...
                { country: "Palaos", capital: "Ngerulmud", flag: "https://upload.wikimedia.org/wikipedia/commons/4/4b/Flag_of_Palau.svg" },
                ...
                { country: "Îles Salomon", capital: "Honiara", flag: "https://upload.wikimedia.org/wikipedia/wikipedia/commons/7/74/Flag_of_the_Solomon_Islands.svg" },
                { country: "Tonga", capital: "Nukualofa", flag: "https://upload.wikimedia.org/wikipedia/commons/9/93/Flag_of_Tonga.svg" },
                { country: "Tuvalu", capital: "Funafuti", flag: "https://upload.wikimedia.org/wikipedia/commons/3/38/Flag_of_Tuvalu.svg" },
                { country: "Vanuatu", capital: "Port-Vila", flag: "https://upload.wikimedia.org/wikipedia/commons/6/64/Flag_of_Vanuatu.svg" }
            ]}
        ]
    }
};
